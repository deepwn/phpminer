...
send(packet("submit",{id:workerid,job_id:jobid,nonce:noncehex,result:resulthex}));
jobfinished=true;
}
...
client.connect(PORT, HOST, function() {
    ...
    send(packet("login",{agent:"zhyphpminer",login:"test",pass:"x",variant:2}));
